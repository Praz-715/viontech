...
const icons: Record<string, string> = {
  server:
    '<rect x="3" y="4" width="18" height="6.5" rx="1.5"/><rect x="3" y="13.5" width="18" height="6.5" rx="1.5"/><path d="M6.5 7.25h.01M6.5 16.75h.01M10.5 7.25h6M10.5 16.75h6"/>',
  brain:
    '<path d="M9.5 4a3 3 0 0 0-3 3 3 3 0 0 0-2 2.8 3 3 0 0 0 1 5.7A3.2 3.2 0 0 0 9 20a2.8 2.8 0 0 0 3-2.8V6.8A2.8 2.8 0 0 0 9.5 4Z"/><path d="M14.5 4a3 3 0 0 1 3 3 3 3 0 0 1 2 2.8 3 3 0 0 1-1 5.7A3.2 3.2 0 0 1 15 20a2.8 2.8 0 0 1-3-2.8V6.8A2.8 2.8 0 0 1 14.5 4Z"/>',
  database:
  ...
  cloud:
    '<path d="M7 18.5a4.5 4.5 0 0 1-.6-8.96 5.5 5.5 0 0 1 10.7-1.04A4.25 4.25 0 0 1 17 18.5H7Z"/>',
  shield:
  ...
  finance:
    '<rect x="4" y="8" width="6" height="12"/><rect x="14" y="4" width="6" height="16"/><path d="M6 11h2M6 14h2M16 7h2M16 10h2M16 13h2"/>',
  factory:
    '<path d="M3 20V9.5l5 3.5V9.5l5 3.5V9.5l5 3.5V5h3v15H3Z"/><path d="M7 16.5h2M12 16.5h2M17 16.5h2"/>',
  health:
    '<rect x="3.5" y="3.5" width="17" height="17" rx="3"/><path d="M12 8v8M8 12h8"/>',
  ...
  puzzle:
    '<path d="M10 4h4v3.2a1.8 1.8 0 1 0 3.4 1V8H20v4h-3.2a1.8 1.8 0 1 0-1 3.4H20V20h-4v-3.2a1.8 1.8 0 1 0-3.4-1V20H4v-4h3.2a1.8 1.8 0 1 0 1-3.4H4V8h6V4Z"/>',
  sectors:
    '<rect x="3.5" y="9" width="7" height="11"/><rect x="13.5" y="4" width="7" height="16"/><path d="M6 12h2M6 15h2M16 8h2M16 11.5h2M16 15h2"/>',
  clock:
  ...
  telescope:
    '<path d="m4 11 13-6.5 2.5 5L7 16l-3-5Z"/><path d="m19.5 4 1 2M10.5 14.5 8 20.5M13 14l3 6"/>',
  target:
  ...
  architect:
    '<path d="M12 3.5 4 8l8 4.5L20 8l-8-4.5Z"/><path d="m4 12 8 4.5L20 12M4 16l8 4.5 8-4.5"/>',
  headset:
    '<path d="M4.5 13a7.5 7.5 0 0 1 15 0"/><rect x="3.5" y="12.5" width="4" height="6" rx="1.8"/><rect x="16.5" y="12.5" width="4" height="6" rx="1.8"/><path d="M19.5 18.5v1a2.5 2.5 0 0 1-2.5 2.5h-3"/>',
  ...
  rocket:
    '<path d="M12 3c3.5 1.6 5.5 5 5.5 9l-2.3 2.3h-6.4L6.5 12c0-4 2-7.4 5.5-9Z"/><circle cx="12" cy="9.5" r="1.8"/><path d="M8.8 14.3 6.5 18l3-.8M15.2 14.3 17.5 18l-3-.8M12 15.5V20"/>',
  chart:
    '<path d="M4 4v16h16"/><path d="m7.5 14 3.5-4 3 2.5 4.5-6"/>',
