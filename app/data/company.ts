...
export const company = {
  ...
  headline: 'Solusi Pengadaan Terpercaya untuk Kebutuhan Anda',
  bidang:
...
/** Banner "Solusi Pengadaan Terintegrasi" — the five supply pillars. */
export const pillars = [
  ...
  },
  {
    ...
    image: '/images/produk/05_Perlengkapan_Gudang_Logistik.webp',
  },
] as const
...
export const sectors = [
  {
    ...
    items: [
      ...
      'Mendukung kebutuhan pusat & daerah',
      'Standar sesuai instansi',
    ],
  },
  {
    icon: 'shield',
    ...
    items: ['Fasilitas barak & asrama', 'Perlengkapan operasional', 'Produk kuat & tahan lama'],
  },
  {
    icon: 'building',
    title: 'BUMN & BUMD',
  ...
  },
  {
    ...
    items: [
      ...
      'Peralatan gudang & operasional',
      'Solusi efisiensi kerja',
    ],
  },
] as const
